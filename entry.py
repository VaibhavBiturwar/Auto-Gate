...
def click():
    ...
    try:
        ...
        url = "INSERT INTO entry (owner_name, mob, block, flat_no) VALUES('"+oname+"','"+mob+"','"+block+"','"+flat_no+"')"
...
b1 =Button(window , text="Save" , font=("monospaced" , 20) , command = click).grid(row=5, column=0 , columnspan=2)

ext =Button(window , text="Exit" , font=("monospaced" , 20) , command = exit).grid(row=6, column=0 , columnspan=2)
